...
part 'tap_up_details_methods.dart';
part 'tap_move_details_methods.dart';
part 'long_press_down_details_methods.dart';
part 'long_press_start_details_methods.dart';
part 'long_press_move_update_details_methods.dart';
part 'long_press_end_details_methods.dart';
part 'drag_down_details_methods.dart';
part 'drag_start_details_methods.dart';
part 'drag_update_details_methods.dart';
part 'drag_end_details_methods.dart';
part 'scale_start_details_methods.dart';
part 'scale_update_details_methods.dart';
part 'scale_end_details_methods.dart';
part 'force_press_details_methods.dart';
...
part 'type_registry_helpers.dart';
