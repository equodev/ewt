...
class ActionPopupState extends SubState<ActionPopup> implements SingleTickerProviderStateMixin {
  ...
  protected Widget build(BuildContext context) {
    return AnimatedBuilder(_animation, (bldContext, child) -> {
          return Transform_scale()
              ...
              .child(Opacity(_animation.value()).child(child));
        })
        .child(Material()
  ...
  List<String> getCurrentActionSteps() {
    return Arrays.stream(
            widget().subStep.actions.get(widget().subStep.currentAction).split(" "))
        .toList();
  }
}
                    ...
                    Center()
                        .child(Column()
                            ...
                            .children(List.of(
                                ...
                                SizedBox().height(24),
                                ElevatedButton(isPopupVisible ? this::closePopup : this::showPopup)
