...
.actions(List.of(TextButton(() -> Navigator.pop(context))
.child(Text("OK"))));
}
...
@Override protected  MyHomePageState createState() {
...
.children(List.of(Text("Hello World!")
.style(TextStyle()
.fontSize(24.0)
.fontWeight(FontWeight.bold())
.color(Colors.blue())), Container()
.height(20.0), Text("Welcome to my first Flutter application")
.style(TextStyle()
.fontSize(16.0))))))
