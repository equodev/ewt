...
import 'tap_up_details_methods.dart' as tudm;
import 'tap_move_details_methods.dart' as tmdm;
import 'long_press_down_details_methods.dart' as lpddm;
import 'long_press_start_details_methods.dart' as lpsdm;
import 'long_press_move_update_details_methods.dart' as lpmudm;
import 'long_press_end_details_methods.dart' as lpedm;
import 'drag_down_details_methods.dart' as dddm;
import 'drag_start_details_methods.dart' as dsdm;
import 'drag_update_details_methods.dart' as dudm;
import 'drag_end_details_methods.dart' as dedm;
import 'scale_start_details_methods.dart' as ssdm;
import 'scale_update_details_methods.dart' as sudm;
import 'scale_end_details_methods.dart' as sedm;
import 'force_press_details_methods.dart' as fpdm;
import 'draggable_details_methods.dart' as ddmm;
...
g.LongPressDownDetails? longPressDownDetails;
w.LongPressStartDetails? longPressStartDetails;
w.LongPressMoveUpdateDetails? longPressMoveUpdateDetails;
w.LongPressEndDetails? longPressEndDetails;
w.DragDownDetails? dragDownDetails;
w.DragStartDetails? dragStartDetails;
w.DragUpdateDetails? dragUpdateDetails;
w.DragEndDetails? dragEndDetails;
w.ScaleStartDetails? scaleStartDetails;
...
g.PointerExitEvent? pointerExitEvent;
g.PointerHoverEvent? pointerHoverEvent;
w.Curve? curve;
w.Cubic? cubic;
...
w.ClipRect? clipRect;
w.ClipRSuperellipse? clipRSuperellipse;
...
w.Baseline? baseline;
w.DefaultTextStyle? defaultTextStyle;
w.Directionality? directionality;
w.OverflowBox? overflowBox;
w.AbsorbPointer? absorbPointer;
w.IgnorePointer? ignorePointer;
w.RepaintBoundary? repaintBoundary;
w.FractionalTranslation? fractionalTranslation;
w.UnconstrainedBox? unconstrainedBox;
w.FlutterLogo? flutterLogo;
w.PhysicalModel? physicalModel;
w.Banner? banner;
...
m.Badge? badge;
m.SelectableText? selectableText;
m.InkWell? inkWell;
...
m.DropdownMenuItem? dropdownMenuItem;
m.DropdownButton? dropdownButton;
m.Radio? radio;
...
m.BackButton? backButton;
m.CloseButton? closeButton;
m.DrawerButton? drawerButton;
m.EndDrawerButton? endDrawerButton;
...
tudm.TapUpDetailsMethods? tapUpDetailsMethods;
tmdm.TapMoveDetailsMethods? tapMoveDetailsMethods;
lpddm.LongPressDownDetailsMethods? longPressDownDetailsMethods;
lpsdm.LongPressStartDetailsMethods? longPressStartDetailsMethods;
lpmudm.LongPressMoveUpdateDetailsMethods? longPressMoveUpdateDetailsMethods;
lpedm.LongPressEndDetailsMethods? longPressEndDetailsMethods;
dddm.DragDownDetailsMethods? dragDownDetailsMethods;
dsdm.DragStartDetailsMethods? dragStartDetailsMethods;
dudm.DragUpdateDetailsMethods? dragUpdateDetailsMethods;
dedm.DragEndDetailsMethods? dragEndDetailsMethods;
ssdm.ScaleStartDetailsMethods? scaleStartDetailsMethods;
sudm.ScaleUpdateDetailsMethods? scaleUpdateDetailsMethods;
sedm.ScaleEndDetailsMethods? scaleEndDetailsMethods;
fpdm.ForcePressDetailsMethods? forcePressDetailsMethods;
ddmm.DraggableDetailsMethods? draggableDetailsMethods;
