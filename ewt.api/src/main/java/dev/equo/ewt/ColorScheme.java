...
public class ColorScheme extends NativeObj.Base {
  ...
  public static ColorSchemeColorSchemeBuilder colorScheme(Brightness brightness, Color primary, Color onPrimary, Color secondary, Color onSecondary, Color error, Color onError, Color surface, Color onSurface) {
    return ColorSchemeColorSchemeBuilder.colorSchemeColorScheme(brightness, primary, onPrimary, secondary, onSecondary, error, onError, surface, onSurface);
  }
  @Builder.Factory
