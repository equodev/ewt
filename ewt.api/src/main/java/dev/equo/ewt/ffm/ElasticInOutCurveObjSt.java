 ...
 * }
 */
public class ElasticInOutCurveObjSt {
    ...
    private static final OfDouble period$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("period"));
     ...
     * }
     */
    public static final OfDouble period$layout() {
     ...
     * }
     */
    public static double period(MemorySegment struct) {
     ...
     * }
     */
    public static void period(MemorySegment struct, double fieldValue) {
