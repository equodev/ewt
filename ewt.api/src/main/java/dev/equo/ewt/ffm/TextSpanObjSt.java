...
public class TextSpanObjSt {
     ...
     * }
     */
    public static final OfInt spellOut$layout() {
     ...
     * }
     */
    public static final long spellOut$offset() {
        return spellOut$OFFSET;
    }
     ...
     * }
     */
    public static int spellOut(MemorySegment struct) {
        return struct.get(spellOut$LAYOUT, spellOut$OFFSET);
    }
     ...
     * }
     */
    public static void spellOut(MemorySegment struct, int fieldValue) {
        struct.set(spellOut$LAYOUT, spellOut$OFFSET, fieldValue);
    }
