...
public final class ValueChangedForBoolFFI {
    ...
    private static final MethodHandle UP$MH = StarterBridge.upcallHandle(ValueChangedForBoolFFI.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(ValueChangedForBoolFFI.Function fi, Arena arena) {
